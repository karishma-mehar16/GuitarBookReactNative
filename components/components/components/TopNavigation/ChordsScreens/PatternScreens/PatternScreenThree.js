...
const PatternScreenThree = () => {
    return (
        <Container>
            <Content>
                <View style={styles.container}>
                    <View style={{ flex: 1, paddingVertical: 20, paddingHorizontal: 5, borderWidth: 1, borderColor: 'gray', shadowColor: 'lightgray', }}>
                        <Image style={{ width: '100%', height: 200, resizeMode: 'stretch' }} source={{ uri: 'https://keytomusicnorth.com/wp-content/uploads/2017/11/Pop-strumming-pattern-1-1024x378.png' }} />
                    </View>
...
export default PatternScreenThree
